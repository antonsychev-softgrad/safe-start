...
(1, NULL, 1, 'root', 'Safety', '', '', '', 'yes', 1, '2013-10-04', 1, 1, 0, 0),
(2, NULL, 1, 'root', 'Cabin', '', '', '', '', 2, '2013-10-04', 1, 1, 0, 0),
(3, NULL, 1, 'root', 'Structural', '', '', '', '', 3, '2013-10-04', 1, 1, 0, 0),
(4, NULL, 1, 'root', 'Mechanical', '', '', '', '', 4, '2013-10-04', 1, 1, 0, 0),
(5, NULL, 1, 'root', 'Trailer', '', '', '', '', 5, '2013-10-04', 1, 1, 0, 1),
(6, NULL, 1, 'root', 'Crane', '', '', '', '', 7, '2013-10-04', 1, 1, 0, 1),
(7, NULL, 1, 'root', 'Auxiliary motor', '', '', '', '', 6, '2013-10-04', 1, 1, 0, 1),
(8, NULL, 1, 'root', 'Earthmoving plant', '', '', '', '', 8, '2013-10-04', 1, 1, 0, 1),
(9, NULL, 1, 'root', 'Work platform', '', '', '', '', 9, '2013-10-04', 1, 1, 0, 1),
...
(12, 1, 1, 'radio', 'Are you authorised in the use of this vehicle?', 'Authorised person', 'Do not inspect any vehicle unless you are authorised', 'Authorised person', 'no', 3, '2013-10-04', 1, 1, 0, 0),
(13, 1, 1, 'radio', 'Is the first aid kit present and fully stocked?', 'First aid kit', '', 'First aid kit', 'no', 4, '2013-10-04', 1, 0, 0, 0),
(14, 1, 1, 'radio', 'Is the fire extinguisher present?', 'Fire extinguisher', '', 'Fire extinguisher', 'no', 5, '2013-10-04', 1, 1, 0, 0),
(15, 1, 1, 'datePicker', 'Date of next inspection- fire extinguisher', '', '', '', '', 6, '2013-10-04', 1, 1, 0, 0),
...
(18, 2, 1, 'group', 'Are the following items operating as designed?', '', '', '', '', 1, '2013-10-04', 1, 1, 0, 0),
...
(29, 28, 1, 'radio', 'Are you authorised to inflate or change tyres?', '', 'Do not work on tyres unless authorised', '', 'no', 4, '2013-10-04', 1, 1, 0, 0),
...
(32, 4, 1, 'group', 'Are the fluid levels acceptable?', '', '', '', '', 2, '2013-10-04', 1, 1, 0, 0),
...
(44, 5, 1, 'text', 'Plant ID', '', '', '', '', 1, '2013-10-04', 1, 1, 0, 0),
(45, 5, 1, 'text', 'Type of trailer', '', '', '', '', 2, '2013-10-04', 1, 1, 0, 0),
(46, 5, 1, 'datePicker', 'Registration expiry', '', '', '', '', 3, '2013-10-04', 1, 1, 0, 0),
...
(53, 5, 1, 'radio', 'Are you authorised to inflate/change tyres?', 'Person Authorised For Tyres?', 'Do not work on tyres unless authorised', 'Person Authorised For Tyres?', 'no', 8, '2013-10-04', 1, 1, 0, 0),
(55, 7, 1, 'text', 'Hours', '', '', '', '', 1, '2013-10-04', 1, 1, 0, 0),
...
(77, 9, 1, 'radio', 'Are the outriggers and their locking mechanism working properly?', 'Outriggers', '', 'Outriggers', 'no', 3, '2013-10-04', 1, 1, 0, 0),
(78, 9, 1, 'radio', 'Is the slew ring free of damage?', 'Slew ring', '', 'Slew ring', 'no', 4, '2013-10-04', 1, 1, 0, 0),
(79, 9, 1, 'radio', 'Are all welds, boom sections and other structural elements free of damage?', 'Welds, boom sections', '', 'Welds, boom sections', 'no', 5, '2013-10-04', 1, 1, 0, 0),
(80, 9, 1, 'radio', 'Are the attachment points, emergency descent device and handrails in place?', 'Attachment points, handrails', '', 'Attachment points, handrails', 'no', 6, '2013-10-04', 1, 1, 0, 0),
