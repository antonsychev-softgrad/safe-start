...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.ux.Fileup": "app/ux/Fileup.js",
  "Ext.ux.event": "app/ux/event",
  "SafeStartApp": "app",
  "SafeStartApp.view.ViewPort": "app.js"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "SafeStartApp.controller.Auth": [],
  "SafeStartApp.controller.Companies": [],
  "SafeStartApp.controller.Company": [],
  "SafeStartApp.controller.CompanyVehicles": [],
  "SafeStartApp.controller.Contact": [],
  "SafeStartApp.controller.DefaultVehicles": [],
  "SafeStartApp.controller.Main": [],
  "SafeStartApp.controller.UserVehicles": [],
  "SafeStartApp.controller.Users": [],
  ...
  "SafeStartApp.store.AbstractStore": [],
  "SafeStartApp.store.AbstractTreeStore": [],
  "SafeStartApp.store.Alerts": [],
  "SafeStartApp.store.AllAlerts": [],
  ...
  "SafeStartApp.store.mixins.FilterByField": [],
  "SafeStartApp.view.Main": [],
  "SafeStartApp.view.ViewPort": [],
  ...
  "SafeStartApp.view.field.ReadOnly": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "SafeStartApp.store.mixins.FilterByField": [],
  "SafeStartApp.view.Main": [
    "widget.SafeStartMainView"
  ],
  "SafeStartApp.view.ViewPort": [
    "widget.SafeStartViewPort"
  ],
  "SafeStartApp.view.base.dialog": [
    "widget.SafeStartAbstractDialog"
  ],
  "SafeStartApp.view.components.FileUpload": [
    "widget.imageupload"
  ],
  "SafeStartApp.view.components.UpdateChecklist": [
    "widget.SafeStartUpdateChecklist"
  ],
  "SafeStartApp.view.dialogs.UserProfile": [
    "widget.SafeStartUserProfileDialog"
  ],
  "SafeStartApp.view.field.ReadOnly": [
    "widget.readonlyfield"
  ],
  "SafeStartApp.view.forms.Auth": [
    "widget.SafeStartAuthForm"
  ],
  "SafeStartApp.view.forms.ChecklistField": [
    "widget.SafeStartChecklistFieldForm"
  ],
  "SafeStartApp.view.forms.Company": [
    "widget.SafeStartCompanyForm"
  ],
  "SafeStartApp.view.forms.CompanySettings": [
    "widget.SafeStartCompanySettingsForm"
  ],
  "SafeStartApp.view.forms.CompanyUser": [
    "widget.SafeStartCompanyUserForm"
  ],
  "SafeStartApp.view.forms.Contact": [
    "widget.SafeStartContactForm"
  ],
  "SafeStartApp.view.forms.UserProfile": [
    "widget.SafeStartUserProfileForm"
  ],
  "SafeStartApp.view.forms.Vehicle": [
    "widget.SafeStartVehicleForm"
  ],
  "SafeStartApp.view.forms.VehicleCustomFields": [
    "widget.SafeStartVehicleCustomFieldsForm"
  ],
  "SafeStartApp.view.pages.Alerts": [
    "widget.SafeStartAlertsPage"
  ],
  "SafeStartApp.view.pages.Auth": [
    "widget.SafeStartAuthPage"
  ],
  "SafeStartApp.view.pages.Companies": [
    "widget.SafeStartCompaniesPage"
  ],
  "SafeStartApp.view.pages.Company": [
    "widget.SafeStartCompanyPage"
  ],
  "SafeStartApp.view.pages.CompanySettings": [
    "widget.SafeStartCompanySettingsPage"
  ],
  "SafeStartApp.view.pages.Contact": [
    "widget.SafeStartContactPage"
  ],
  "SafeStartApp.view.pages.SystemSettings": [
    "widget.SafeStartSystemSettingsPage"
  ],
  "SafeStartApp.view.pages.SystemStatistic": [
    "widget.SafeStartSystemStatisticPage"
  ],
  "SafeStartApp.view.pages.Users": [
    "widget.SafeStartUsersPage"
  ],
  "SafeStartApp.view.pages.Vehicles": [
    "widget.SafeStartVehiclesPage"
  ],
  "SafeStartApp.view.pages.nestedlist.Vehicles": [
    "widget.SafeStartNestedListVehicles"
  ],
  "SafeStartApp.view.pages.panel.CheckListsChangesReport": [
    "widget.SafeStartCheckListsChangesReportPanel"
  ],
  "SafeStartApp.view.pages.panel.InspectionBreakdownsReport": [
    "widget.SafeStartInspectionBreakdownsReportPanel"
  ],
  "SafeStartApp.view.pages.panel.LeftContainer": [
    "widget.SafeStartLeftContainer"
  ],
  "SafeStartApp.view.pages.panel.SystemGeneralReport": [
    "widget.SafeStartSystemGeneralReportPanel"
  ],
  "SafeStartApp.view.pages.panel.UpdateChecklist": [
    "widget.SafeStartUpdateChecklistPanel"
  ],
  "SafeStartApp.view.pages.panel.UpdateVehicleChecklist": [
    "widget.SafeStartUpdateVehicleChecklistPanel"
  ],
  "SafeStartApp.view.pages.panel.VehicleAlert": [
    "widget.SafeStartVehicleAlertPanel"
  ],
  "SafeStartApp.view.pages.panel.VehicleAlerts": [
    "widget.SafeStartVehicleAlertsPanel"
  ],
  "SafeStartApp.view.pages.panel.VehicleInspection": [
    "widget.SafeStartVehicleInspection"
  ],
  "SafeStartApp.view.pages.panel.VehicleInspectionDetails": [
    "widget.SafeStartVehicleInspectionDetails"
  ],
  "SafeStartApp.view.pages.panel.VehicleInspections": [
    "widget.SafeStartVehicleInspectionsPanel"
  ],
  "SafeStartApp.view.pages.panel.VehicleReport": [
    "widget.SafeStartVehicleReportPanel"
  ],
  "SafeStartApp.view.pages.panel.VehicleUsers": [
    "widget.SafeStartVehicleUsersPanel"
  ],
  "SafeStartApp.view.pages.panel.Vehicles": [
    "widget.SafeStartVehiclesPanel"
  ],
  "SafeStartApp.view.pages.toolbar.Main": [
    "widget.SafeStartMainToolbar"
  ]
});
