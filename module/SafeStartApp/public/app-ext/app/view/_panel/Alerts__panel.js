        ...
        Ext.apply(this, {
            ...
            items: [{
			    ...
			    if (this.down('datefield[name=due-date-field]').isValid()){
                        ...
                        //scope: this,
                        handler: function() {
                            if ( confirm("Are you sure you want to monitor this alert? This will extend the due date by 60 days and you will be logged as the person responsible for monitoring this alert.") ) {
